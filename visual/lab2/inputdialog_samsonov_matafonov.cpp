...
InputDialog_Samsonov_Matafonov::InputDialog_Samsonov_Matafonov(QWidget* pwgt) : QDialog(pwgt)
{
...
QString InputDialog_Samsonov_Matafonov::firstName() const
{
    return m_ptxtFirstName->text();
}

QString InputDialog_Samsonov_Matafonov::lastName() const
{
